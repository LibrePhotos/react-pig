...
var Tile = /*#__PURE__*/React__default.memo(function Tile(_ref) {
  ...
  }, undefined != TopRightOverlay && /*#__PURE__*/React__default.createElement(TopRightOverlay, {
    item: item
  })), /*#__PURE__*/React__default.createElement("div", {
    className: styles$2.overlaysBottomLeft
  }, undefined != BottomLeftOverlay && /*#__PURE__*/React__default.createElement(BottomLeftOverlay, {
    item: item
  }))));
});
Tile.propTypes = {
...
/**
  ...
  */
function getMinAspectRatio (containerWidth, scaleOfImages) {
...
function computeLayoutGroups (_ref) {
  var imageData = _ref.imageData,
      ...
      scaleOfImages = _ref.scaleOfImages;
  // Compute the minimum aspect ratio that should be applied to the rows.
  var minAspectRatio = getMinAspectRatio(wrapperWidth, scaleOfImages);
